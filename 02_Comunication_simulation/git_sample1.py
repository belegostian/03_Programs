...
class HelloServer:
    ...
    async def init(self):
        ...
        await self.server.import_xml(os.path.join(self.model_filepath, "Opc.Ua.Woodworking.NodeSet2.xml"))
        ...
        await self.server.get_node('ns=4;i=7822').write_value(ua.LocalizedText("Manufacturer Name", "de_CH")) #Manufacturer
        ...
        await self.server.get_node('ns=4;i=7826').write_value(ua.Variant(1972, ua.VariantType.UInt16)) #YearOfConstruction
