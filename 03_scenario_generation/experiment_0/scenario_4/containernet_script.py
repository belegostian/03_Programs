...
comp2 = net.addDocker('comp2', ip='10.0.0.200', dcmd='python wrapper.py', dimage='awc_twd:11-15-22', mem_limit='256m', memswap_limit='768m', cpu_period=100000, cpu_quota=100000, environment={"AWC_SERVER_IPS": "10.0.0.120,10.0.0.121,10.0.0.122,10.0.0.123,10.0.0.124,10.0.0.125", "TWD_SERVER_IPS": "10.0.0.124,10.0.0.125,10.0.0.134,10.0.0.135,10.0.0.136,10.0.0.137"})
comp1 = net.addDocker('comp1', ip='10.0.0.210', dcmd='python wrapper.py', dimage='awc_js_pm_twd:11-15-22', mem_limit='192m', memswap_limit='576m', cpu_period=100000, cpu_quota=75000, environment={"AWC_SERVER_IPS": "", "JS_SERVER_IPS": "10.0.0.110,10.0.0.111,10.0.0.112,10.0.0.113,10.0.0.114,10.0.0.115,10.0.0.120,10.0.0.121,10.0.0.122,10.0.0.123,10.0.0.124,10.0.0.125,10.0.0.130,10.0.0.131,10.0.0.132,10.0.0.133,10.0.0.134,10.0.0.135,10.0.0.136,10.0.0.137", "PM_SERVER_IPS": "10.0.0.130,10.0.0.131", "TWD_SERVER_IPS": "10.0.0.114,10.0.0.115"})
comp4 = net.addDocker('comp4', ip='10.0.0.211', dcmd='python tool_wear_detection.py', dimage='tool_wear_detection:ver2', mem_limit='96m', memswap_limit='288m', cpu_period=100000, cpu_quota=37500, environment={"TWD_SERVER_IPS": ""})
comp3 = net.addDocker('comp3', ip='10.0.0.220', dcmd='python automatic_workpiece_changing.py', dimage='automatic_workpiece_changing:ver2', mem_limit='96m', memswap_limit='288m', cpu_period=100000, cpu_quota=37500, environment={"AWC_SERVER_IPS": ""})
...
info ('*** Creating links\n')
net.addLink(sw1, sw0, cls=TCLink, use_htb=True)
net.addLink(sw0, sw2, cls=TCLink, use_htb=True)
net.addLink(sw0, sw3, cls=TCLink, use_htb=True)
...
net.addLink(comp1, sw1, cls=TCLink, bw=1000, delay='0.05ms', use_htb=True)
