...
comp2 = net.addDocker('comp2', ip='10.0.0.200', dcmd='python wrapper.py', dimage='js_pm:11-15-22', mem_limit='256m', memswap_limit='768m', cpu_period='100000', cpu_quota='100000', environment={"JS_SERVER_IPS": "10.0.0.110,10.0.0.111,10.0.0.112,10.0.0.113,10.0.0.114,10.0.0.115", "PM_SERVER_IPS": ""})
comp3 = net.addDocker('comp3', ip='10.0.0.210', dcmd='python tool_wear_detection.py', dimage='tool_wear_detection:ver1', mem_limit='96m', memswap_limit='288m', cpu_period='100000', cpu_quota='37500', environment={"TWD_SERVER_IPS": "10.0.0.114,10.0.0.115,10.0.0.124,10.0.0.125"})
