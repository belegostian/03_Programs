...
comp1 = net.addDocker('comp1', ip='10.0.0.210', dcmd='python wrapper.py', dimage='awc_js_twd:11-15-22', mem_limit='192m', memswap_limit='576m', cpu_period=100000, cpu_quota=75000, environment={"AWC_SERVER_IPS": "", "JS_SERVER_IPS": "", "TWD_SERVER_IPS": "10.0.0.130,10.0.0.131"})
comp3 = net.addDocker('comp3', ip='10.0.0.211', dcmd='python job_scheduling.py', dimage='job_scheduling:ver1', mem_limit='96m', memswap_limit='288m', cpu_period=100000, cpu_quota=37500, environment={"JS_SERVER_IPS": "10.0.0.120,10.0.0.121,10.0.0.122,10.0.0.123,10.0.0.124,10.0.0.125"})
comp4 = net.addDocker('comp4', ip='10.0.0.212', dcmd='python wrapper.py', dimage='js_pm:11-15-22', mem_limit='96m', memswap_limit='288m', cpu_period=100000, cpu_quota=37500, environment={"JS_SERVER_IPS": "", "PM_SERVER_IPS": "10.0.0.114,10.0.0.115,10.0.0.124,10.0.0.125,10.0.0.134,10.0.0.135,10.0.0.136,10.0.0.137"})
