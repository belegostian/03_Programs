...
def generate_topology(switch_dict, plot=False):
    G = nx.Graph()
...
switch_to_topo = generate_topology(switch_dict, plot=True)
...
device_to_topo = add_nodes_to_topology(switch_to_topo, device_dict, plot=True)
computer_to_topo = add_nodes_to_topology(device_to_topo, computer_dict, plot=True)

def add_app_nodes_to_topology(G, application_dict, computer_dict, plot=False):
